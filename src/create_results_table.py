		...
		for color_mode in color_modes:
			for work_dir in work_dirs:
				...
				for aux_task in aux_tasks:
					...
					temp_data_dir = f"logs/{main_task}/{aux_task}/{work_dir}/eval_train_env"
					...
					for reset_mode in reset_agent_modes:
						temp_data_dir = f"logs/{main_task}/{aux_task}/{work_dir}/{reset_mode}"
				...
				# Save LaTeX table
				suffix = "_freeze_decoder" if "freeze_decoder" in work_dir else ""
				table_file = f"results_table_{main_task}_{color_mode}{suffix}.txt"
