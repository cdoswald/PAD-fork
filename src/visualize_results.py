...
if __name__ == "__main__":
	...
	sub_dirs = ["reset_episode", "reset_none"]
	for sub_dir in sub_dirs:
		...
		for plot_update_step in plot_update_steps:
			...
			min_y = min(min_y, np.min(rewards_episode_by_avg_seed))
		...
		axes.set_ylim(0, int(max_y * 1.05))
		...
		save_path = os.path.join(results_dir, f"avg_episode_reward_mode_{mode}.png")
